...
const LoadingIndicator = () => (
  <div className="flex flex-col items-center justify-center py-20">
    ...
    <p className="mt-4 themed-text-secondary text-lg">Loading series...</p>
  </div>
);
...
const SeriesPage = () => {
  ...
  if (searchTerm && !isLoading) {
    ...
    pageTitleContent = <>Browse Series ({totalMovieCount > 0 ? totalMovieCount : isLoading ? '' : '0'} total)</>;
  }
  ...
  return (
    <div className="container mx-auto px-2 sm:px-4 py-8 themed-text z-">
      ...
      {selectedMovie && (
        <MovieModal movie={selectedMovie} onClose={handleCloseMovieModal} type={"series"} />
      )}
